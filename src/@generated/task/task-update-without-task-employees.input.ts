...
import { ServiceUpdateOneRequiredWithoutTasksNestedInput } from '../service/service-update-one-required-without-tasks-nested.input';

@InputType()
export class TaskUpdateWithoutTaskEmployeesInput {
