...
import { EmployeeUpdateOneRequiredWithoutServicesNestedInput } from '../employee/employee-update-one-required-without-services-nested.input';
...
@InputType()
export class ServiceUpdateWithoutServiceRequestInput {
