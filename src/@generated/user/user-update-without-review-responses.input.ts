...
import { UserReportUpdateManyWithoutUserNestedInput } from '../user-report/user-report-update-many-without-user-nested.input';
import { PersonUpdateOneWithoutUserNestedInput } from '../person/person-update-one-without-user-nested.input';

@InputType()
export class UserUpdateWithoutReviewResponsesInput {
