...
import { NestedEnumUserReportsStatusWithAggregatesFilter } from './nested-enum-user-reports-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumUserReportsStatusFilter } from './nested-enum-user-reports-status-filter.input';

@InputType()
export class EnumUserReportsStatusWithAggregatesFilter {
