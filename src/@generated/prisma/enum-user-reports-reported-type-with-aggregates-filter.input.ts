...
import { NestedEnumUserReportsReportedTypeWithAggregatesFilter } from './nested-enum-user-reports-reported-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumUserReportsReportedTypeFilter } from './nested-enum-user-reports-reported-type-filter.input';

@InputType()
export class EnumUserReportsReportedTypeWithAggregatesFilter {
