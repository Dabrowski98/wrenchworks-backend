...
import { NestedEnumWorkshopsDetailsStatusNullableWithAggregatesFilter } from './nested-enum-workshops-details-status-nullable-with-aggregates-filter.input';
...
@InputType()
export class EnumWorkshopsDetailsStatusNullableWithAggregatesFilter {
