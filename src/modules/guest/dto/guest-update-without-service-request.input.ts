...
import { CustomerUpdateOneWithoutGuestNestedInput } from '../../customer/dto/customer-update-one-without-guest-nested.input';

@InputType()
export class GuestUpdateWithoutServiceRequestInput {
    ...
    @HideField()
    customer?: CustomerUpdateOneWithoutGuestNestedInput;
}
