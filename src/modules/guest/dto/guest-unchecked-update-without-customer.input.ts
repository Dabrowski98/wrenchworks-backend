...
import { VehicleUncheckedUpdateOneWithoutGuestNestedInput } from '../../vehicle/dto/vehicle-unchecked-update-one-without-guest-nested.input';
...
@InputType()
export class GuestUncheckedUpdateWithoutCustomerInput {
    ...
    @Field(() => VehicleUncheckedUpdateOneWithoutGuestNestedInput, {nullable:true})
    @Type(() => VehicleUncheckedUpdateOneWithoutGuestNestedInput)
    @ValidateNested()
    @Type(() => VehicleUncheckedUpdateOneWithoutGuestNestedInput)
    vehicle?: VehicleUncheckedUpdateOneWithoutGuestNestedInput;
