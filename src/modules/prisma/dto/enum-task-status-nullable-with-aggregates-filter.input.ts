...
import { NestedEnumTaskStatusNullableWithAggregatesFilter } from './nested-enum-task-status-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumTaskStatusNullableFilter } from './nested-enum-task-status-nullable-filter.input';

@InputType()
export class EnumTaskStatusNullableWithAggregatesFilter {
