...
import { NestedEnumFuelTypeNullableWithAggregatesFilter } from './nested-enum-fuel-type-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumFuelTypeNullableFilter } from './nested-enum-fuel-type-nullable-filter.input';

@InputType()
export class EnumFuelTypeNullableWithAggregatesFilter {
