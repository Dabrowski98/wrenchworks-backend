...
import { NestedEnumUserReportTypeWithAggregatesFilter } from './nested-enum-user-report-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumUserReportTypeFilter } from './nested-enum-user-report-type-filter.input';

@InputType()
export class EnumUserReportTypeWithAggregatesFilter {
