...
import { NestedEnumUsersStatusNullableWithAggregatesFilter } from './nested-enum-users-status-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumUsersStatusNullableFilter } from './nested-enum-users-status-nullable-filter.input';

@InputType()
export class EnumUsersStatusNullableWithAggregatesFilter {
