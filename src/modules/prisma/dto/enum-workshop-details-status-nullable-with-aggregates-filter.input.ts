...
import { NestedEnumWorkshopDetailsStatusNullableWithAggregatesFilter } from './nested-enum-workshop-details-status-nullable-with-aggregates-filter.input';
...
@InputType()
export class EnumWorkshopDetailsStatusNullableWithAggregatesFilter {
