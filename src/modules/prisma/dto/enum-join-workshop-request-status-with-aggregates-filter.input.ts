...
import { NestedEnumJoinWorkshopRequestStatusWithAggregatesFilter } from './nested-enum-join-workshop-request-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumJoinWorkshopRequestStatusFilter } from './nested-enum-join-workshop-request-status-filter.input';

@InputType()
export class EnumJoinWorkshopRequestStatusWithAggregatesFilter {
